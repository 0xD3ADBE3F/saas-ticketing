...
export const metadata = {
  title: "Ticket Portaal - Instellingen",
  description: "Pas het uiterlijk van je ticketbestelportaal aan",
};
...
export default async function DesignSettingsPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold mb-2">Ticket Portaal</h1>
      ...
      <DesignSettingsForm
        ...
        initialShowOnPublicEventsPage={settings?.showOnPublicEventsPage ?? true}
      />
    </div>
  );
}
