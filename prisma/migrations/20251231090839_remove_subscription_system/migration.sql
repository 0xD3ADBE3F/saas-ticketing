...
-- Step 1: Add PLATFORM_FEE to existing InvoiceType enum
...
-- Step 3: Migrate existing invoice data from subscription_invoices to invoices
...
-- Step 6: Now drop old subscription tables
-- DropForeignKey
...
-- Step 7: Update InvoiceType enum to only have PLATFORM_FEE
...
-- Step 8: Drop subscription-related organization columns
-- DropIndex
...
-- Step 9: Drop subscription-related enums
